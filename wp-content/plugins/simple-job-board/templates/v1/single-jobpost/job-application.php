            ...
            if ($privacy_policy_content) {
                ...
                <div class="form-group">
                    <?php if ($privacy_policy_label) { ?>
                        <label class="sjb-privacy-policy-label"><?php echo sprintf( __("%s",'simple-job-board'), esc_attr($privacy_policy_label)); ?></label>
                    <?php } ?>  
                    <p class="sjb-privacy-policy"><?php echo sprintf( __("%s",'simple-job-board'), stripslashes_deep(trim($privacy_policy_content))); ?></p>
                </div>
                <?php
                if (0 === $total_sections) {
                    echo '</div>';
